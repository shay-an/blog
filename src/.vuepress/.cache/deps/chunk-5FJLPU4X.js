// node_modules/.pnpm/registry.npmjs.org+mermaid@10.2.4/node_modules/mermaid/dist/mermaid-be6aa4a6.js
function ql(t9) {
...
var J0 = async () => {
  const { diagram: t9 } = await import("./c4Diagram-80a4d5b6-P3AVFNO6.js");
...
var i_ = async () => {
  const { diagram: t9 } = await import("./flowDiagram-cee391fd-HVC2EFLN.js");
...
var s_ = async () => {
  const { diagram: t9 } = await import("./flowDiagram-v2-ccf242f5-R4MNAEAZ.js");
...
var c_ = async () => {
  const { diagram: t9 } = await import("./erDiagram-7c3fcf92-HHF6CXNQ.js");
...
var p_ = async () => {
  const { diagram: t9 } = await import("./gitGraphDiagram-9c32cfbe-TWYM2RK2.js");
...
var y_ = async () => {
  const { diagram: t9 } = await import("./ganttDiagram-770f21fb-RW5R75KC.js");
...
var T_ = async () => {
  const { diagram: t9 } = await import("./infoDiagram-8f094d68-KYNOH4G5.js");
...
var v_ = async () => {
  const { diagram: t9 } = await import("./pieDiagram-c8232900-AJ7B47NY.js");
...
var L_ = async () => {
  const { diagram: t9 } = await import("./quadrantDiagram-073c0def-OXYHTOUM.js");
...
var O_ = async () => {
  const { diagram: t9 } = await import("./requirementDiagram-9d898ddc-IZXYUCCJ.js");
...
var N_ = async () => {
  const { diagram: t9 } = await import("./sequenceDiagram-8f3ae6b9-FOB4KTZJ.js");
...
var z_ = async () => {
  const { diagram: t9 } = await import("./classDiagram-440b88cd-EUSSQJQ3.js");
...
var U_ = async () => {
  const { diagram: t9 } = await import("./classDiagram-v2-d771589e-CH2G34ZL.js");
...
var X_ = async () => {
  const { diagram: t9 } = await import("./stateDiagram-cb3c1d96-YSRAZDKN.js");
...
var Q_ = async () => {
  const { diagram: t9 } = await import("./stateDiagram-v2-fab09385-B2XC7RS6.js");
...
var ry = async () => {
  const { diagram: t9 } = await import("./journeyDiagram-cea58833-T2CATZFI.js");
...
var dy = async () => {
  const { diagram: t9 } = await import("./flowchart-elk-definition-8bb5cff5-K3ZXDFYB.js");
...
var _y = async () => {
  const { diagram: t9 } = await import("./timeline-definition-2ae65266-ZLUPAWQY.js");
...
var by = async () => {
  const { diagram: t9 } = await import("./mindmap-definition-976fcb28-YDDRXVJ4.js");
...
mermaid/dist/mermaid-be6aa4a6.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5FJLPU4X.js.map
